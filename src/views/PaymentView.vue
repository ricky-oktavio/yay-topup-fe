      ...
      <div class="container footer-inner">
        <div class="footer-logo">
          <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 6L20 23L32 6H25.2L20 14.5L14.8 6H8Z" fill="url(#ftrGrad2)" />
            <path d="M17.5 20.5H22.5V34H17.5V20.5Z" fill="url(#ftrGrad2)" />
            <circle cx="28" cy="11" r="3.5" fill="#EC4899" />
            <defs>
              <linearGradient id="ftrGrad2" x1="8" y1="6" x2="32" y2="34" gradientUnits="userSpaceOnUse">
        ...
        <nav class="footer-links">
          <a href="#" @click.prevent="showNotice('Privacy Policy')">Privacy Policy</a>
          <a href="#" @click.prevent="showNotice('Terms of Service')">Terms of Service</a>
          <a href="#" @click.prevent="showNotice('Refund Policy')">Refund Policy</a>
          <a href="#" @click.prevent="showNotice('Contact Support')">Contact Support</a>
        </nav>
